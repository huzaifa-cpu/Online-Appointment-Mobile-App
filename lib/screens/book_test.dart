...
import 'package:side_hospital_app/change_notifier/patient_test_provider.dart';
...
import 'package:side_hospital_app/models/patient_test.dart';
...
import 'package:side_hospital_app/services/patient_service.dart';
import 'package:side_hospital_app/services/test_service.dart';
import 'package:side_hospital_app/widgets/custom_button.dart';
import 'package:side_hospital_app/widgets/custom_square_button.dart';
import 'package:side_hospital_app/services/patient_test_service.dart';
            ...
            child:
              ...
              NeuCard(
                ...
                child: DatePicker(
                  ...
                  selectedTextColor: _colors.white,
                  onDateChange: (date) {
                    // New date selected
                    setState(() {
                      _selectedValue = date;
                ...
                children: [
                  CustomSquareButton(
                    ...
                    attribute: Text(
                      "10:00-12:00 AM",
                      style: TextStyle(
                          color: btn1 ? _colors.white : _colors.grey,
                          fontSize: 13),
                    ),
                  ),
                  CustomSquareButton(
                    ...
                    attribute: Text(
                      "12:00-2:00 PM",
                      style: TextStyle(
                          color: btn2 ? _colors.white : _colors.grey,
                          fontSize: 13),
                    ),
                  ),
                ],
                ...
                children: [
                  CustomSquareButton(
                    ...
                    attribute: Text(
                      "2:00-4:00 PM",
                      style: TextStyle(
                          color: btn3 ? _colors.white : _colors.grey,
                          fontSize: 13),
                    ),
                  ),
                  CustomSquareButton(
                    ...
                    attribute: Text(
                      "4:00-6:00 PM",
                      style: TextStyle(
                          color: btn4 ? _colors.white : _colors.grey,
                          fontSize: 13),
                    ),
                  ),
                ],
                ...
                children: [
                  CustomSquareButton(
                    ...
                    attribute: Text(
                      "6:00-8:00 PM",
                      style: TextStyle(
                          color: btn5 ? _colors.white : _colors.grey,
                          fontSize: 13),
                    ),
                  ),
                  CustomSquareButton(
                    ...
                    attribute: Text(
                      "8:00-10:00 PM",
                      style: TextStyle(
                          color: btn6 ? _colors.white : _colors.grey,
                          fontSize: 13),
                    ),
                  ),
                ],
